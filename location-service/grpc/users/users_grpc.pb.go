...
func (c *userServiceClient) GetUserName(ctx context.Context, in *GetUserNameReq, opts ...grpc.CallOption) (*GetUserNameRes, error) {
...
func (UnimplementedUserServiceServer) GetUserName(context.Context, *GetUserNameReq) (*GetUserNameRes, error) {
...
func _UserService_GetUserName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserName(ctx, req.(*GetUserNameReq))
	}
