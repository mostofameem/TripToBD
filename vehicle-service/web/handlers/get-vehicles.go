...
func (handlers *Handlers) GetVehicle(w http.ResponseWriter, r *http.Request) {
	...
	vehicle, err := handlers.vehicleSvc.GetVehicleById(r.Context(), id)
	if err != nil {
...
func (handlers *Handlers) GetVehicles(w http.ResponseWriter, r *http.Request) {
	params := utils.GetPaginationParams(r)

	vehicles, err := handlers.vehicleSvc.GetVehicles(r.Context(), &params)
	if err != nil {
